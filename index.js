...
var royal       = ['ydpa', 'ydpb', 'ydpn', 'tuanku', 'tengku', 'ybhg'];
var federal     = ['tun', 'toh', 'tan', 'sri', 'datuk', 'datin', 'dato\''];
var common      = ['ir', 'dr', 'tuan', 'puan', 'en', 'cik', 'mr', 'abang', 'dayang'];
var titles      = [ 'doctor', 'dr', 'miss', 'mister', 'mr', 'mrs', 'ms', 'prof', 'professor' ];
var salutations = royal.concat(federal, common, titles);
var suffixes    = [ 'jr', 'sr' ];
